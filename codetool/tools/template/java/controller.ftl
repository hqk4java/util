...
import com.bluedon.common.base.BaseMybatisController;
import com.bluedon.common.page.Pagination;
import com.bluedon.common.web.DataGrid;
import com.bluedon.common.web.JsonData;
import com.bluedon.yhact.core.util.PageUtils;
...
public class ${table.controllerName} extends BaseMybatisController {
	...
	@ResponseBody
	public JsonData deleteById(String  ids) throws Exception {
		JsonData json = new JsonData();
		try {
